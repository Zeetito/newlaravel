{{-- whatever you named the file in components folder --}}
<x-layout>
                  ...
                  <div class="col-lg-5 pl-lg-5 pb-3 py-lg-5">
                    <form action="/register" method="POST" id="registration-form">
                      ...
                      <div class="form-group">
                        ...
                        <input name="password" value='{{old('password')}}' id="password-register" class="form-control" type="password" placeholder="Create a password" />
                        @error('password')
                        <p class='m-0 small alert alert-danger shadow-sm '>{{$message}}</p>
                     @enderror
                      </div>
